...
function TermsContent() {
  const sections = [
    ...
    { title: '4. Funcionamento do Programa', body: '4.1. O afiliado receberá um cupom exclusivo para divulgação.\n4.2. O cupom concederá ao cliente final um desconto de 3% (três por cento) sobre o valor da compra, quando aplicado no momento do pagamento.\n4.3. A comissão do afiliado será de R$25,00 (vinte e cinco reais) por peça vendida, vinculada ao uso do cupom.\n4.4. Serão consideradas válidas apenas vendas:\n• Pagas\n• Aprovadas\n• Não canceladas ou estornadas\n4.5. A JOIAS MAROMBA poderá:\n• Validar vendas\n• Cancelar comissões indevidas\n• Corrigir eventuais erros sistêmicos\n4.6. A empresa se reserva o direito de:\n• Alterar o percentual de desconto do cupom\n• Suspender cupons específicos\n• Encerrar campanhas promocionais a qualquer momento' },
    { title: '5. Bonificações e Metas', body: '5.1. O site poderá apresentar campanhas promocionais, metas e bonificações adicionais.\n5.2. Tais bonificações:\n• Não são obrigatórias\n• Não constituem garantia de pagamento\n• Não configuram vínculo ou remuneração fixa\n5.3. Os bônus somente serão concedidos mediante cumprimento integral das regras da campanha.\n5.4. O não atingimento das metas não gera qualquer obrigação por parte da JOIAS MAROMBA.' },
    { title: '6. Pagamentos e Saques', body: '6.1. O afiliado poderá solicitar saque a qualquer momento.\n6.2. O pagamento será realizado via PIX em até 24 horas, dentro do horário comercial das 08:00 às 22:00.\n6.3. Solicitações fora desse horário serão processadas no próximo período.\n6.4. A JOIAS MAROMBA não se responsabiliza por:\n• Dados bancários incorretos\n• Falhas de instituições financeiras\n6.5. Valores provenientes de cancelamentos, fraudes ou estornos poderão ser descontados.' },
    ...
    { title: '8. Afiliados Patrocinados', body: '8.1. Afiliados patrocinados poderão ter regras específicas definidas em contrato separado.' },
    ...
    { title: '10. Bloqueio e Cancelamento', body: '10.1. A empresa poderá suspender contas e cancelar comissões a qualquer momento em caso de:\n• Fraude\n• Violação dos termos\n• Uso indevido da marca' },
    { title: '11. Tributação', body: '11.1. O afiliado é responsável por seus tributos.' },
